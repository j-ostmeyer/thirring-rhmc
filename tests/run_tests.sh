...
ALL_TESTS="test_gauss0 test_gaussp test_derivs test_meson test_measure_shamir test_measure_wilson test_congrad test_dslash_shamir test_dslashd_shamir test_dslashd_reqs_shamir test_dslash_wilson test_dslashd_wilson test_dslashd_reqs_wilson"
