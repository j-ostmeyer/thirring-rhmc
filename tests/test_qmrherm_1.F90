...
program test_qmrherm_1
  ...
  if (generate) then
#ifdef MPI
    write_file(x(1:kthird_l, 1:ksizex_l, 1:ksizey_l, 1:ksizet_l, :), 'test_qmrherm_1_x.dat', MPI_Double_Complex)
    write_file(Phi0(1:kthird_l, 1:ksizex_l, 1:ksizey_l, 1:ksizet_l, :, :), 'test_qmrherm_1_Phi0.dat', MPI_Double_Complex)
#else
    ...
    check_equality(itercg, 2, 'itercg', 'test_qmrherm_1')
    check_sum(delta_x, 50, 'x', sum_delta_x, MPI_Double_Complex, 'test_qmrherm_1')
    check_max(delta_x, 0.5, 'x', max_delta_x, MPI_Double_Precision, 'test_qmrherm_1')
    check_sum(delta_Phi0, 3003, 'Phi0', sum_delta_Phi0, MPI_Double_Complex, 'test_qmrherm_1')
    check_max(delta_Phi0, 2.5, 'Phi0', max_delta_Phi0, MPI_Double_Precision, 'test_qmrherm_1')
  end if
