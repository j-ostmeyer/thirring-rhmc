...
program test_qmrherm_2
  ...
  if (generate) then
#ifdef MPI
    write_file(x(1:kthird_l, 1:ksizex_l, 1:ksizey_l, 1:ksizet_l, :), 'test_qmrherm_2_x.dat', MPI_Double_Complex)
    write_file(Phi0(1:kthird_l, 1:ksizex_l, 1:ksizey_l, 1:ksizet_l, :, :), 'test_qmrherm_2_Phi0.dat', MPI_Double_Complex)
#else
