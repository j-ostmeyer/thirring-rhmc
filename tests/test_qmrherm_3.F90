...
program test_qmrherm_3
  ...
  if (generate) then
#ifdef MPI
    write_file(x(:, 1:ksizex_l, 1:ksizey_l, 1:ksizet_l, :), 'test_qmrherm_3_x.dat', MPI_Double_Complex)
    write_file(Phi0(:, 1:ksizex_l, 1:ksizey_l, 1:ksizet_l, :, :), 'test_qmrherm_3_Phi0.dat', MPI_Double_Complex)
#else
